...
func newGeminiSession(ctx context.Context, cmd string, extraArgs []string, workDir, model, mode, resumeID string, extraEnv []string, timeout time.Duration, mcpConfig core.MCPConfig) (*geminiSession, error) {
