...
```bash
curl -L -o dirextalk-connect.tar.gz https://github.com/YingSuiAI/dirextalk-connect/releases/latest/download/dirextalk-connect-v1.3.23-linux-amd64.tar.gz
tar xzf dirextalk-connect.tar.gz
chmod +x dirextalk-connect-v1.3.23-linux-amd64
sudo mv dirextalk-connect-v1.3.23-linux-amd64 /usr/local/bin/dirextalk-connect
```
